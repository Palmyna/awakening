...
Ce document définit le cadre de monétisation de **Project Awakening**.
...
Project Awakening adopte une approche économique progressive :

1. couvrir les coûts d’exploitation et de production continue ;
2. permettre progressivement de financer durablement l’équipe ;
3. soutenir éventuellement le développement de la licence si les résultats du projet le permettent.

Aucun objectif financier chiffré n’est fixé à ce stade.

La recherche de revenus ne doit jamais prendre le pas sur l’équité, la transparence ou le respect des joueurs. Une offre peut être refusée même si elle est rentable lorsqu’elle contredit ces principes.
...
Le projet combine des interdictions absolues et des limites mesurables.
...
### 4.2. Systèmes exclus du périmètre initial
...
* les rotations excessivement fréquentes ;
* les informations ambiguës sur la fin ou le retour d’une offre ;
* les exclusivités non annoncées avant l’acquisition.

## 8. Prix et promotions
...
* les rotations commerciales excessivement fréquentes ;
* les prix volontairement difficiles à comparer ;
* toute présentation masquant le coût réel d’un produit.

### 8.2. Définition des prix

Les prix seront établis après :

* une étude de marché ;
* une estimation des coûts de production ;
* des tests.
...
## 10. Évolutions possibles après le lancement
...
* rendre aucune dépense nécessaire à une progression normale.
...
Aucune publicité n’est prévue dans le périmètre initial.

Une éventuelle réévaluation après le lancement ne devra pas conduire à intégrer par défaut des publicités imposées ou influençant la progression.
...
Aucune monnaie premium n’est prévue dans le modèle initial.

Son ajout futur nécessiterait un besoin réel et ne devrait pas masquer le coût réel des produits.
...
La monétisation doit être évaluée à partir :

* de critères de refus explicites ;
...
* Les indicateurs détaillés et leurs méthodes de mesure.
* Les seuils numériques déclenchant une révision ou un refus.
