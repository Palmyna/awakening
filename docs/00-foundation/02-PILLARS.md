...
Le plaisir de jeu doit venir autant, et surtout, du développement des monstres possédés que de l’obtention de nouvelles créatures.

Le joueur construit une relation durable avec ses monstres en les faisant progresser depuis leur forme de base, en développant leur potentiel et en les accompagnant jusqu’à leur évolution finale.

### Conséquences sur la conception

* Les monstres doivent progresser individuellement en participant aux combats.
...
* Les doublons doivent augmenter le potentiel du monstre sans obliger le joueur à recommencer son évolution.
...
* Réduire le plaisir de progression à l’acquisition répétée de monstres plus rares.
...
Chaque joueur doit pouvoir façonner ses monstres et ses équipes selon ses propres choix.
...
* Les compétences apprises, l’objet équipé, l’évolution et le rôle dans l’équipe doivent contribuer à différencier les monstres.
* Les synergies entre les membres d’une équipe doivent encourager plusieurs compositions.
* La conception des monstres doit favoriser une diversité de builds et d’usages.
* La rareté d’un monstre ne doit pas être son unique source de valeur.

### Ce que le projet doit éviter

* Proposer des monstres dont le développement ne laisse aucun choix significatif au joueur.
...
La réussite doit récompenser en priorité la préparation de l’équipe, la compréhension des monstres, leurs synergies et les choix de composition.
...
* Le joueur doit constituer et optimiser une équipe de six monstres.
...
Les joueurs doivent obtenir principalement les monstres et les invocations grâce au jeu. La monétisation repose avant tout sur des éléments cosmétiques, notamment les illustrations alternatives des cartes, afin de préserver un environnement compétitif équitable.

### Conséquences sur la conception

* Les monstres doivent s’obtenir principalement en jouant.
...
Project Awakening doit construire une licence originale, fondée sur un multivers riche et sur des familles de monstres inédites.
...
La représentation des monstres sous forme de cartes et la collection d’illustrations participent pleinement à cette identité.

### Conséquences sur la conception

* Chaque famille de monstres doit être une création originale.
* Les inspirations doivent être transformées et intégrées à l’identité propre du projet.
* Les familles doivent généralement proposer une progression cohérente entre une forme de base, une évolution intermédiaire et une évolution finale.
* Les illustrations 2D de qualité doivent mettre en valeur les monstres sous forme de cartes.
* Les joueurs doivent pouvoir appliquer librement les illustrations qu’ils ont débloquées à leurs monstres favoris.
...
* Les systèmes doivent permettre l’ajout progressif de monstres, de contenus, de builds et d’illustrations.
