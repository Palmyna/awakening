...
Il complète les [règles de combat](./02-COMBAT.md), les [Skills](./04-SKILLS.md), les [éléments](./05-ELEMENTS.md) et les besoins fonctionnels d’[interface](./20-UI_FLOW.md) sans les remplacer.
...
Les besoins fonctionnels détaillés appartiennent au [document UI Flow](./20-UI_FLOW.md).
